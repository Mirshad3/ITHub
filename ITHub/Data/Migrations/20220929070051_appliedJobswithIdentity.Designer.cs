...
namespace ITHub.Data.Migrations
{
    ...
    [Migration("20220929070051_appliedJobswithIdentity")]
    partial class appliedJobswithIdentity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ITHub.Models.AppliedJobs", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ITHub.Models.CvData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ITHub.Models.JobTechnologies", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ImageUrl = "img/TechLogo/HTML.png",
                            Name = "HTML",
                            Value = "HTML"
                        },
                        new
                        ...
                        {
                            Id = 3,
                            ImageUrl = "img/TechLogo/node.png",
                            Name = "Node",
                            Value = "Node"
                        });
                });
            ...
            modelBuilder.Entity("ITHub.Models.Notifications", b =>
                {
            ...
            modelBuilder.Entity("ITHub.Models.AppliedJobs", b =>
                {
                    b.HasOne("ITHub.Models.CvData", "CvDatas")
                        .WithMany()
                        .HasForeignKey("CvId")
