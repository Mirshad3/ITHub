...
namespace ITHub.Controllers.JobController
{
    public class JobTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Value,Description")] JobType jobType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Value,Description")] JobType jobType)
        {
            if (id != jobType.Id)
            {
                return NotFound();
